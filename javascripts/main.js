                                        ...
                                        if (repo.name.match(/^lab-/ig) && repo.name.match(/^lab-/ig).length) {
                                                $.ajax({
                                                        ...
                                                        var title = document.createElement("h3"),
                                                                ...
                                                                links = document.createElement("section"),
                                                                readmeDOM = document.createElement("div");
                                                        ...
                                                        $.ajax({
                                                                ...
                                                                if (readme.content) {
                                                                        readmeDOM.innerHTML = '<h5 class="showhidereadme"><a class="hideText" href="#">Show/Hide Readme</a></h5><br /><div class="readmeText hide">' + marked(b64DecodeUnicode(readme.content)) + "</div>";
                                                                        readmeDOM.getElementsByClassName("showhidereadme")[0].onclick = function(e) {
                                                                                switch(e.target.className) {
                                                                                        case "showText":
                                                                                                e.target.className = "hideText";
                                                                                                readmeDOM.getElementsByClassName("readmeText")[0].className = "readmeText hide";
                                                                                                break;
                                                                                        case "hideText":
                                                                                        default:
                                                                                                e.target.className = "showText";
                                                                                                readmeDOM.getElementsByClassName("readmeText")[0].className = "readmeText show";
                                                                                }
                                                                                return false;
                                                                        }
                                                                }

                                                                document.getElementById("main_content").appendChild(readmeDOM);
